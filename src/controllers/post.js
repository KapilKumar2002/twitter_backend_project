...
exports.addPost = asyncHandler(async (req, res, next) => {
  ...
  // Map through uploaded files to get their Cloudinary URLs and IDs
  ...
  // Update the user's document with the new post and increment post count
  await User.findByIdAndUpdate(req.user.id, {
    $push: { posts: post._id },
    $inc: { postCount: 1 },
  });

  // Populate the 'user' field with specific properties (avatar, username, fullname)
